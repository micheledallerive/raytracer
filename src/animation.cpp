...
float jumping_ball_position(float base_height, float max_height __maybe_unused, float t __maybe_unused, float sphere_radius __maybe_unused)
{
    return base_height;
}
...
glm::vec3
jumping_ball_scale(float base_height __maybe_unused, float max_height __maybe_unused, float t __maybe_unused, float sphere_radius __maybe_unused,
                   float step_size __maybe_unused)
{
    return glm::vec3(1.0f);
}
